function listPostCreatorVertical(animals, data) {
    ...
    if (animals == null || animals.length == 0) {
        ...
        var noResultDiv = createNoResultsDiv();
...
function AdoptSectionsClean(animals) {
    ...
    if (animals[0] == undefined) {
        cleanAdoptElements();
        document.getElementById('adopt-cats').appendChild(createNoResultsDiv());
        document.getElementById('adopt-dogs').appendChild(createNoResultsDiv());
        document.getElementById('adopt-other').appendChild(createNoResultsDiv());
        return;
    }
...
function LostFoundSectionsClean(animals) {
    ...
    if (animals[0] == undefined) {
        cleanLostFoundElements();
        document.getElementById('lost').appendChild(createNoResultsDiv());
        document.getElementById('found').appendChild(createNoResultsDiv());
        document.getElementById('backInHome').appendChild(createNoResultsDiv());
        return;
    }
...
function cleanLostFoundElements() {
